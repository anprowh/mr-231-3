...
public class Mr231Tests {
        ...
        public void testMr2313Converter() {
            Mr231StationType mr2313 = new Mr231StationType();
            Mr231Converter converter = mr2313.createConverter();
            ...
            // Тестирование сообщения VHW
            searadarMessages3 = converter.convert("$RAVHW,115.6,T,,,46.0,N,,*71");

            // Проверка типа сообщения
            message = searadarMessages3.get(0);
            assertTrue(message instanceof WaterSpeedHeadingMessage);

            // Преобразование сообщения в WaterSpeedHeadingMessage
            WaterSpeedHeadingMessage waterSpeedHeadingMessage = (WaterSpeedHeadingMessage) message;

            //WaterSpeedHeading{msgRecTime=, course=115.6, courseAttr=T, speed=46.0, speedUnit=N}
            // Проверка, что результат соответствует ожидаемому
